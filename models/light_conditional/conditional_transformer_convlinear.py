#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# @file    :   conditional_transformer.py
# @time    :   2021/08/27 15:11:52
...
from ..light_modules.dynamic_conv import DynamicConvolution
from ..light_modules.multi_layer_conv import Conv1dLinear
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.self_attn = DynamicConvolution(wshare=nhead, n_feat=d_model, dropout_rate=dropout, kernel_size_str="3_3", lnum=1)

        # Implementation of Feedforward modelclear
            
        # self.linear1_1 = nn.Linear(d_model, dim_feedforward)
        self.linear1 = Conv1dLinear(in_chans=d_model, hidden_chans=dim_feedforward, kernel_size=1, dropout_rate=dropout)
        
        self.dropout = nn.Dropout(dropout)
        # self.linear2 = nn.Linear(dim_feedforward, d_model)
        self.linear2 = Conv1dLinear(in_chans=dim_feedforward, hidden_chans = d_model, kernel_size=1, dropout_rate=dropout)
    ...
    def forward_post(self,
        ...
        src2 = self.self_attn(q, q, src, src_mask, src_key_padding_mask) # torch.Size([1344, 1, 256])
        # src2 = self.self_attn(q, k, value=src, attn_mask=src_mask,
        #                       key_padding_mask=src_key_padding_mask)[0] # torch.Size([1344, 1, 256])
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        tgt2 = self.self_attn(q, q, q, tgt_mask, tgt_key_padding_mask)
