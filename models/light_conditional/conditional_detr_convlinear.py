#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# @file    :   conditional_detr.py
# @time    :   2021/08/27 15:09:58
...
from ..backbone_condition_detr import build_backbone
from ..matchers.conditional_matcher import build_matcher
from ..segmentation import (DETRsegm, PostProcessPanoptic, PostProcessSegm,
                           dice_loss, sigmoid_focal_loss)
from .conditional_transformer_convlinear import build_transformer
...
class SetCriterion(nn.Module):
    ...
    """
    def __init__(self, num_classes, matcher, weight_dict, focal_alpha, eos_coef, losses):
...
def build(args):
    ...
    criterion = SetCriterion(args.num_classes, matcher=matcher, weight_dict=weight_dict,
                             focal_alpha=args.focal_alpha, eos_coef=args.eos_coef, losses=losses)
    criterion.to(device)
