#!/usr/bin/env python
#Author: Daoming Zong
#Date: 2021-09-09 21:08:00
#LastEditTime: 2021-09-09 23:28:58
#LastEditors: Daoming Zong and Chunya Liu
#Description: 
#FilePath: /models/SmallT/models/parallel_detr.py
...
from .parallel_transformer import build_transformer
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        prob = out_logits.sigmoid() #prob.shape: torch.Size([3, 400, 10])
...
def build(args):
    ...
    if args.masks:
        losses += ["masks"]
    criterion = SetCriterion(args.num_classes, matcher, weight_dict, args.eos_coef, losses, focal_alpha=args.focal_alpha)
    criterion.to(device)
