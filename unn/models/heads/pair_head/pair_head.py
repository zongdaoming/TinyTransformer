...
from .pair import compute_proposal_targets, predict_assos, predict_assos_2
...
__all__ = ['GeneralAssociation', 'TwoBranchAssociation', 
        ...
        if self.training:
            ...
            if self.cfg.get('post_processor', None) is not None:
                ...
                if twice_pro:
                    ...
                    output['dt_assos'] = assos[assos[:, -1] >= 0.3]
                    output = processor.process(output)
