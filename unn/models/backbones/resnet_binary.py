...
from unn.models.quants.binary_conv_factory import BinaryConvFactory
...
def Biconv3x3(in_planes, out_planes, stride=1): #changed
    """3x3 convolution with padding"""
    return BinaryConvFactory.create(
        in_planes,
        out_planes,
        kernel_size=3,
        stride=stride,
...
class BasicBlock(nn.Module): #changed
    expansion = 1
    ...
    def __init__(self,
        ...
        self.conv2 = Biconv3x3(planes, planes)
...
class Bottleneck(nn.Module): #changed
    expansion = 4
    ...
    def __init__(self, inplanes,
        ...
        self.conv1 = BinaryConvFactory.create(
            inplanes,
            planes,
            kernel_size=1,
            stride=stride_1x1,
        ...
        self.conv2 = BinaryConvFactory.create(
            planes,
            planes,
            kernel_size=3,
            stride=stride_3x3,
        ...
        self.add_module(self.norm2_name, norm2)
        self.conv3 = BinaryConvFactory.create(planes, planes * 4, kernel_size=1, bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        BinaryConvFactory.init(conv_cfg, binary_name)
        def check_range(x):
    ...
    @property
    def layer0(self):
        return nn.Sequential(self.conv1, self.norm1, self.nonlinear, self.maxpool)
    ...
    def freeze_layer(self):
        layers = [
            nn.Sequential(self.conv1, self.norm1, self.nonlinear, self.maxpool),
