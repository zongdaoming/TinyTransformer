...
from unn.models.submodules.conv_ws import ConvWS2d
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes,
        ...
        self.add_module(self.norm2_name, norm2)
        self.conv3 = ConvWS2d(planes, planes * 4, kernel_size=1, bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = ConvWS2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False)
        self.add_module(self.norm1_name, norm1)
        self.relu = nn.ReLU(inplace=True)
