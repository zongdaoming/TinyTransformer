...
from .._C import roi_in_pooling

logger = logging.getLogger('global')


class RoIInPoolFunction(Function):
    @staticmethod
...
class RoIInPool(torch.nn.Module):
    ...
    def forward(self, rois, feature, stride):
        ...
        return RoIInPoolFunction.apply(feature, rois, self.pooled_h,
