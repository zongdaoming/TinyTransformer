...
class RoIPool(torch.nn.Module):
    ...
    def __init__(self, pooled_h, pooled_w, spatial_scale=None):
        ...
        if spatial_scale is not None:
            logger.warning('spatial_scale is deprecated when initializing RoIPool'
