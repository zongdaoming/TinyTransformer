#ifndef ROIPOOLING_H_
#define ROIPOOLING_H_
...
int ROIPoolBackwardLaucher(at::Tensor top_diff, const float spatial_scale, const int batch_size, const int num_rois,
