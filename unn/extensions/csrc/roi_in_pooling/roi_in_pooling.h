#ifndef ROIINPOOLING_H_
#define ROIINPOOLING_H_
...
int roi_in_pooling_forward_cuda(
    int pooled_height,
    int pooled_width,
    float spatial_scale,
    at::Tensor features,
...
int roi_in_pooling_backward_cuda(
    int pooled_height, 
    int pooled_width, 
    float spatial_scale,
    at::Tensor  top_grad,
...
int ROIInPoolBackwardLaucher(at::Tensor top_diff, const float spatial_scale, const int batch_size, const int num_rois,
